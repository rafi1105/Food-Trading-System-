...
if(isset($_POST['order'])){
   ...
   $address = 'flat no. '. $_POST['flat'] .' '. $_POST['street'] .' '. $_POST['city'] .' '. $state .' '. $country .' - '. $_POST['pin_code'];
...
<section class="checkout-orders">
   ...
   <form action="" method="POST">
      ...
      <input type="submit" name="order" class="btn1 <?= ($cart_grand_total > 1)?'':'disabled'; ?>" value="place order">
